...
"""
def test_1_selenium_rip_view_page_with_macro(confluence_webdriver, confluence_datasets, confluence_screen_shots):
    extension_ui.rip_view_page_with_macro(confluence_webdriver, confluence_datasets)
